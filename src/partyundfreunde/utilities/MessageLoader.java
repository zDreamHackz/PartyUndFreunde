...
public class MessagesLoader extends LanguageConfiguration {
	...
	private void loadEnglishMessages() {
		set("Party.Error.CommandNotFound", "&cBenutze /party für die Auflistung der Commands!");
		set("Party.CommandUsage.Join", "&8/&5Party join  &8- &7Party beitreten");
		set("Party.CommandUsage.Invite", "&8/&5Party invite  &8- &7Einen Spieler in deine Party einladen");
		set("Party.CommandUsage.List", "&8/&5Party list &8- &7Alle Spieler in aktiver Party auflisten");
		set("Party.CommandUsage.Chat", "&8/&5Party chat  &8- &7Schicke eine Party Nachricht");
		set("Party.CommandUsage.Leave", "&8/&5Party leave &8- &7Die Party verlassen");
		set("Party.CommandUsage.Kick", "&8/&5Party kick  &8- &7Einen Spieler aus der Party kicken");
		set("Party.CommandUsage.Leader", "&8/&5Party leader &5 &8- &7Einen anderen Party-Leader machen");
		set("Party.Command.General.ErrorNoParty", "&5Du musst in einer Party sein.");
		set("Party.Command.General.ErrorNotPartyLeader", "&cDu bist nicht der Leader der Party.");
		set("Party.Command.General.ErrorGivenPlayerIsNotInTheParty", "&cDer Spieler &e[PLAYER] &cist nicht in deiner  Party.");
		set("Party.Command.General.ErrorNoPlayer", "&cDu musst einen Spieler auswählen.");
		set("Party.Command.General.ErrorPlayerNotOnline", "&cDieser Spieler ist nicht online.");
		set("Party.Command.General.DissolvedPartyCauseOfNotEnoughPlayers", "&5Die Party wurde aufgelöst, weil zu wenig Spieler waren.");
		set("Party.Command.General.PlayerHasLeftTheParty", "&6[PLAYER] &bHat die Party verlassen.");
		set("Party.Command.General.ServerSwitched", "&bDie Party betritt den Server &e[SERVER]&b.");
		set("Party.Command.Chat.ErrorNoMessage", "&5Du musst auch was schreiben :D.");
		set("Party.Command.Info.Empty", "leer");
		set("Party.Command.Invite.GivenPlayerEqualsSender", "&7Man kann sich nicht selber einladen.");
		set("Party.Command.Invite.CanNotInviteThisPlayer", "&cDu kannst &e[PLAYER] &cnicht einladen.");
		set("Party.Command.Invite.AlreadyInAParty", "&cDieser Spieler ist schon in einer Party.");
		set("Party.Command.Invite.AlreadyInYourParty", "&e[PLAYER] wurde schon in deine Party eingeladen.");
		set("Party.Command.Invite.MaxPlayersInPartyReached", "&cDie maximale Spieleranzahl lautet [MAXPLAYERSINPARTY].");
		set("Party.Command.Invite.InvitedPlayer", "&6[PLAYER] &bwurde in deine Party eingeladen.");
		set("Party.Command.Invite.YouWereInvitedBY", "&5Du wurdest in die Party von &6[PLAYER]s &5eingeladen!");
		set("Party.Command.Invite.YouWereInvitedBYJSONMESSAGE",
				"&5Join der Party mit diesem Command: &6/Party &6join &6[PLAYER]!");
		set("Party.Command.Invite.YouWereInvitedBYJSONMESSAGEHOVER", "&aKlicke HIER um der Party beizutreten");
		set("Party.Command.Invite.InvitationTimedOutInvited", "&5Die Zeit der Einladung von &6[PLAYER] &5ist bereits abgelaufen!");
